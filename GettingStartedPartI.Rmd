...
This document has benefitted by work done by Emily Voldal, Brian High, Lianne Sheppard, and Chris Zuidema.

**The output (e.g. `.html` or `.pdf`) and source (`.Rmd`) documents are optimally used 
...
within the project's working directory. We will also set up a new project in the first lab.
...
To facilitate this, use the `pacman` package in R instead of 
