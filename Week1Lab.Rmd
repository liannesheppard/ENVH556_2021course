...
included in the [tidyverse](https://www.tidyverse.org).  Our goal in this class is
...
paths set up.
    ...
    + Then tell R where your data reside (see *datasets.path* chunk).  The 
      ...
      systems.
    + See the following chunk to accomplish this:
...
# Note 2:  the smoother for facilty E is behaving strangely becuase so many 
