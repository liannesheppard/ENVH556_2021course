...
# MKmisc:  quantileCI
pacman::p_load(dplyr, tidyr, knitr, Hmisc, EnvStats, BiocManager, MKmisc)

# one dependency needed must be installed through another package
BiocManager::install("limma")
...
x <- rlnorm(n = 1000, mean = 1, sd = 0.92)
