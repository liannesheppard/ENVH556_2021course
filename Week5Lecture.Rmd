...
# 3 observations for the group_loc variable

# TODO Chris:  This version fails in the VCA.implementation chunk.  It has something to do with how group_loc is characterized here vs. in the original coding, below.  Do you know why?  I'd use this version of the code if it didn't cause problems below.

# Lianne, see if this works for you (it does for me). It was a silly object
# class thing. VCA requires class data.frame and not tibble. fvc is still a
# tibble here, though, what I did was just add as.data.frame() to the VCA
# function arguments. Alternatively you could add this to the fvc assignment
# below: %>% as.data.frame()
...
# # Original version: This version works in the VCA.implementation chunk
...
# (slides 21+22)
# note: VCA functions require Data of class data.frame, not tibble, so we've
# made that adjustment in the function arguments
...
Note (not necessarily discussed in lecture):  The fixed effect estimates will change when
