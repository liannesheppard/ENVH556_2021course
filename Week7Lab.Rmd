...
pacman::p_load(knitr, dplyr, tidyr, purrr, tictoc, broom, parallel, Hmisc)
...
Note:  For clarity of display we are presenting only 1,000 subjects.  However,
the sample size of the subject dataset impacts the certainty of the parameter
estimates, so the slopes shown in this figure have more uncertainty than the
slopes estimated in the simulation study with 10,000 subjects.  (Why?)
