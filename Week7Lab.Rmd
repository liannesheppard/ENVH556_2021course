...
#TODO:  Chris, we need x to get the best fit line under the true exposure, either    
  # make dataset longer
...
ggplot(data = temp, aes(x = error_exposure, y = y)) + 
  ...
  geom_abline(intercept = coefs_true[1], slope = coefs_true[2], lty = "dashed", color = "gray") +
