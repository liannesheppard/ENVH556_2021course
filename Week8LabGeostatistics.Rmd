...
TODO or drop:  It would be nice to combine this with our CV code and
show the same performance statistics we used in lab 4.  

TODO:  The following chunk integrates kriging with our cross-validation
function from lab 4.
...
# TODO:  In some testing the points didn't show and I got this warning message:
# Warning message:
# In checkNA("cex") : reached elapsed time limit
# Is this a persistent problem?  It seems OK in the knitted output
