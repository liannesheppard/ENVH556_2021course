...
# Next time this course is taught, should be able to remove this part and
...
bind_rows(
  ...
  krige.cv.stats(meuse.CV5, "log(zinc) OK: 5-fold CV"),
  krige.cv.stats(meuse.CVLOO, "log(zinc) OK: LOO CV"),
  krige.cv.stats(meuse.CV5uk, "log(zinc) UK on sqrt(dist): 5-fold CV"),
  krige.cv.stats(meuse.CVLOOuk, "log(zinc) UK on sqrt(dist): LOO CV"),
