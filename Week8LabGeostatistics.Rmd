...
# Let's make a map
ggplot(data=meuse) + geom_sf(data=meuse.riv) + geom_sf(aes(size=zinc))
...
# This works because our projecton is in meter units
# This code buffers the points of the measurements by 500 m,
# obtains the smallest possible rectangle around those points,
# (bounding box), and crops the river polygon to that rectangle
