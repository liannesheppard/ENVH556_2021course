...
filenames <- list.files(data_dir) %>% str_subset("car2")
...
Another way to remove background in mobile monitoring data is to fit a smoother
to the data and subtract the fitted values from the observations.
