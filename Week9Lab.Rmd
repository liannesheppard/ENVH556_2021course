...
In addition to date formats, you'll likely encounter dates with various time
zones, daylight savings conventions, and perhaps even issues with simulataneous
measurements on either side of the international date line. Accounting for these
issues will make it easier to handle variables of the `datetime` class.
...
These instruments collect ultrafine particles (UFPs) at the 1 second time resolution.  An unscreened P-Trak collects particles in the range of 20 - 1,000 nm while the screened P-Track collects particles in the range of 50-1,000 nm.  Thus, having both allows some rudimentary understanding of particle size distributions.  Both instruments provide data in units of pt/cm$^#$.
