...
ggplot(data = ts_data) + 
  geom_line(aes(x = datetime, y = co2_background_pct, lty = "solid", color = "black")) + 
  geom_line(aes(x = datetime, y = co2_background_min, lty = "solid", color = "red")) + 
  geom_line(aes(x = datetime, y = co2_background_pctl, lty = "dashed", color = "black")) + 
  ...
  scale_linetype_identity(name = "Background Type",
